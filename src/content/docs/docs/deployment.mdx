...
The debug APK (`.build/skip-export/AppName-debug.apk`) is signed with a temporary key. You can install it on an emulator or device for testing, but you will need to uninstall it before installing a newer version (unlike production apps, which can be upgraded in place).

The release APK (`.build/skip-export/AppName.apk`) is not signed by default. You must sign it before distributing through the Play Store or installing on a device. You can integrate signing into your CI workflow, or use the built-in support in your project's `Android/app/build.gradle.kts`, which looks for `keystore.properties` and `keystore.jks` files in the `Android/app/` folder.
...
[10:59:53]: ▸   skip-model: https://github.com/skiptools/skip-model.git @ 0.7.0
[10:59:53]: ▸   skip-av: https://github.com/skiptools/skip-av.git @ 0.0.2
[10:59:53]: ▸   skip-unit: https://github.com/skiptools/skip-unit.git @ 0.7.2
[10:59:53]: ▸   skip: https://github.com/skiptools/skip.git @ 0.8.46
[10:59:53]: ▸   skip-ui: https://github.com/skiptools/skip-ui.git @ 0.9.6
[10:59:53]: ▸   skip-foundation: https://github.com/skiptools/skip-foundation.git @ 0.6.11
[10:59:53]: ▸   skip-lib: https://github.com/skiptools/skip-lib.git @ 0.7.13

...
Congratulations! You have created and launched your first dual-platform app. At this point, try making changes to the project and re-launching the app to see how Skip complements your normal edit-build-run cycle.

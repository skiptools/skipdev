...
This sample app is available at [https://github.com/skiptools/skipapp-hello.git](https://source.skip.tools/skipapp-hello.git), which can be checked out and run once Skip is [installed](/docs/gettingstarted/).
:::

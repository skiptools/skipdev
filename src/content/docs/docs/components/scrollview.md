...
Skip support for [SwiftUI.ScrollView](https://developer.apple.com/documentation/swiftui/scrollview).

The following example screens and source code is from SkipUI's
[Showcase](/docs/samples/skipapp-showcase/) sample app
[`ScrollViewPlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/ScrollViewPlayground.swift)


<!-- 
<div class="showcase-screenshot-container">
<img alt="Android screenshot for ScrollView component (light mode)" src="http://assets.skip.dev/showcase/ScrollView-android-light.png" />
<img alt="iPhone screenshot for ScrollView component (light mode)" src="http://assets.skip.dev/showcase/ScrollView-iphone-light.png" />
<img alt="iPhone screenshot for ScrollView component (dark mode)" src="http://assets.skip.dev/showcase/ScrollView-iphone-dark.png" />
<img alt="Android screenshot for ScrollView component (dark mode)" src="http://assets.skip.dev/showcase/ScrollView-android-dark.png" />
</div>
 -->

...
Skip support for [SwiftUI.Animation](https://developer.apple.com/documentation/swiftui/animation).

The following example screens and source code is from SkipUI's
[Showcase](/docs/samples/skipapp-showcase/) sample app
[`AnimationPlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/AnimationPlayground.swift)


<!-- 
<div class="showcase-screenshot-container">
<img alt="Android screenshot for Animation component (light mode)" src="http://assets.skip.dev/showcase/Animation-android-light.png" />
<img alt="iPhone screenshot for Animation component (light mode)" src="http://assets.skip.dev/showcase/Animation-iphone-light.png" />
<img alt="iPhone screenshot for Animation component (dark mode)" src="http://assets.skip.dev/showcase/Animation-iphone-dark.png" />
<img alt="Android screenshot for Animation component (dark mode)" src="http://assets.skip.dev/showcase/Animation-android-dark.png" />
</div>
 -->

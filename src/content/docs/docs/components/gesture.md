...
Skip support for [SwiftUI.Gesture](https://developer.apple.com/documentation/swiftui/gesture) on Android.
...
[`GesturePlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/GesturePlayground.swift)


<div class="showcase-screenshot-container">
<img alt="Android screenshot for Gesture component (light mode)" src="http://assets.skip.dev/showcase/Gesture-android-light_framed.png" />
<img alt="iPhone screenshot for Gesture component (light mode)" src="http://assets.skip.dev/showcase/Gesture-iphone-light_framed.png" />
<img alt="iPhone screenshot for Gesture component (dark mode)" src="http://assets.skip.dev/showcase/Gesture-iphone-dark_framed.png" />
<img alt="Android screenshot for Gesture component (dark mode)" src="http://assets.skip.dev/showcase/Gesture-android-dark_framed.png" />
</div>

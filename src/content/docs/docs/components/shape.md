...
Skip support for [SwiftUI.Shape](https://developer.apple.com/documentation/swiftui/shape) on Android.
...
[`ShapePlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/ShapePlayground.swift)


<div class="showcase-screenshot-container">
<img alt="Android screenshot for Shape component (light mode)" src="http://assets.skip.dev/showcase/Shape-android-light_framed.png" />
<img alt="iPhone screenshot for Shape component (light mode)" src="http://assets.skip.dev/showcase/Shape-iphone-light_framed.png" />
<img alt="iPhone screenshot for Shape component (dark mode)" src="http://assets.skip.dev/showcase/Shape-iphone-dark_framed.png" />
<img alt="Android screenshot for Shape component (dark mode)" src="http://assets.skip.dev/showcase/Shape-android-dark_framed.png" />
</div>

...
Skip support for [SwiftUI.List](https://developer.apple.com/documentation/swiftui/list) on Android.
...
[`ListPlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/ListPlayground.swift)


<div class="showcase-screenshot-container">
<img alt="Android screenshot for List component (light mode)" src="http://assets.skip.dev/showcase/List-android-light_framed.png" />
<img alt="iPhone screenshot for List component (light mode)" src="http://assets.skip.dev/showcase/List-iphone-light_framed.png" />
<img alt="iPhone screenshot for List component (dark mode)" src="http://assets.skip.dev/showcase/List-iphone-dark_framed.png" />
<img alt="Android screenshot for List component (dark mode)" src="http://assets.skip.dev/showcase/List-android-dark_framed.png" />
</div>

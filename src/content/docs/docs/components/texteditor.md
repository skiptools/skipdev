...
Skip support for [SwiftUI.TextEditor](https://developer.apple.com/documentation/swiftui/texteditor) on Android.
...
[`TextEditorPlayground.swift`](https://github.com/skiptools/skipapp-showcase/tree/main/Sources/Showcase/TextEditorPlayground.swift)


<div class="showcase-screenshot-container">
<img alt="Android screenshot for TextEditor component (light mode)" src="http://assets.skip.dev/showcase/TextEditor-android-light_framed.png" />
<img alt="iPhone screenshot for TextEditor component (light mode)" src="http://assets.skip.dev/showcase/TextEditor-iphone-light_framed.png" />
<img alt="iPhone screenshot for TextEditor component (dark mode)" src="http://assets.skip.dev/showcase/TextEditor-iphone-dark_framed.png" />
<img alt="Android screenshot for TextEditor component (dark mode)" src="http://assets.skip.dev/showcase/TextEditor-android-dark_framed.png" />
</div>

---
title: "Getting Started with Skip"
duration: "12:47"
video: "https://skip.tools/assets/video/getting-started-2.mov"
poster: "https://assets.skip.tools/tour/getting-started-2-poster.png"
yt: "https://youtu.be/AWRPubyQ9V8"
description: "This video demonstrates getting started with using Skip. It walks through installing Skip and creating your first dual-platform app. Follow along with the video and you will have your own SwiftUI app running side-by-side on the iOS Simulator and Android emulator."
---
...
We have an iOS app, with iOS unit tests, a using Xcode, and now it’s all running on Android.

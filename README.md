...
- Please do not add images to this repository, as they bloat the size and slow down the page build time. Image and video assets should be instead added to [https://github.com/skiptools/assets.skip.dev/](https://github.com/skiptools/assets.skip.dev/), which can be referenced with a redirect link to `https://assets.skip.dev`. For example, [https://assets.skip.dev/intro/skip_xcode.png](https://assets.skip.dev/intro/skip_xcode.png) redirects to [https://raw.githubusercontent.com/skiptools/assets.skip.dev/main/intro/skip_xcode.png](https://raw.githubusercontent.com/skiptools/assets.skip.dev/main/intro/skip_xcode.png).
